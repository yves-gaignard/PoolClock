...
public:
	...
	/**
	 * \brief The mode of the seven segment display. This also defines which segments have to be linked and which ones can be left out,
	...
	/**
	 * \brief The size of the seven segment display. 
	 */
	enum SevenSegmentSize {
		LONG_SEGMENT, 	/** has 7 leds */
		SHORT_SEGMENT, 	/** has 3 leds */
		DOT_SEGMENT		/** has 1 led */
	};

private:
	Segment* Segments[7];
	SevenSegmentMode DisplayMode;
