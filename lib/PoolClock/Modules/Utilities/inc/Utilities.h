...
static const std::string fct_itoa(int i) {
  char buffer[12] = {0};
...
static const std::string fct_ftoa(float f, const char * format = "%6.2f") {
  char buffer[20] = {0};
...
static const std::string fct_dtoa(double f, const char * format = "%6.2f") {
  char buffer[20] = {0};
  sprintf(buffer, format, f);
  std::string _str = buffer;
  return _str;
