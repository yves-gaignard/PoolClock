 ...
 * \brief Header for the PoolClockUIg class 
 */

#ifndef _POOL_CLOCK_UI_H_
#define _POOL_CLOCK_UI_H_
 ...
 *
 */
void PoolClockUILoopCode(void* pvParameters);
...
{
private:
	static PoolClockUI* instance;
	TaskHandle_t PoolClockUILoop;
...
public:
	 ...
	 */
	static PoolClockUI* getInstance();
